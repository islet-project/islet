...
# it takes a pretty while..
# setup-tf.sh N --> N means a number of CPUs used in buliding tensorflow. please set a proper number for the host machine.
```
...
```
$ cd $(islet)
$ ./scripts/fvp-cca --normal-world=linux-net --realm=linux --rmm-log-level=info --hes --no-telnet
