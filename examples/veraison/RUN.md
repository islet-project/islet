...
* Islet: [https://github.com/islet-project/islet](https://github.com/islet-project/islet) that provides:

    * the whole SW/FW stack and scripts for running the emulated environment under the QEMU
    * Islet HES [https://github.com/islet-project/islet/tree/main/hes](https://github.com/islet-project/islet/tree/main/hes)
    * kvmtool-rim-measurer from [https://github.com/islet-project/islet/tree/main/third-party/](https://github.com/islet-project/islet/tree/main/third-party/)

* Various miscelanous tools and libraries for Remote Attestation

    * rust-rsi: [https://github.com/islet-project/rust-rsi](https://github.com/islet-project/rust-rsi)
      A library implementing token and RSI related functionalities (fetching, parsing).
    * rsictl: [https://github.com/islet-project/rsictl](https://github.com/islet-project/rsictl)
      Tool for performing RSI operations from user space.
    * rocli: [https://github.com/islet-project/rocli](https://github.com/islet-project/rocli)
      Tool for provisioning reference token and CPAK to the Veraison services.
    * ratls: [https://github.com/islet-project/ratls](https://github.com/islet-project/ratls)
      A library implementing RaTLS protocol for attestation purposes.
    * realm-verifier: [https://github.com/islet-project/realm-verifier](https://github.com/islet-project/realm-verifier)
      A library for verifying RIM and REMs with reference values.
    * veraison-verifier: [https://github.com/islet-project/veraison-verifier](https://github.com/islet-project/veraison-verifier)
...
`CCA/islet/scripts/qemu-cca`). To do this do the following:
...
QEMU emulator and the HES application.
...
This will take some time. Wait until you have a realm loaded. Then load RSI
module and get the token:
...
matter. Now we can kill the QEMU (ctrl-c on the QEMU terminal).
...
* generate/get the realm you want to use (for now generated by `qemu-cca` script,
...
* Build the kvmtool-rim-measurer tool according to the description [https://github.com/islet-project/3rd-kvmtool/blob/kvmtool-rim-measurer/eac5/BUILD-RIM-MEASURER](https://github.com/islet-project/3rd-kvmtool/blob/kvmtool-rim-measurer/eac5/BUILD-RIM-MEASURER)
...
* Prepared realm that won't be modified anymore:
  ...
  For now we use the one generated by qemu-cca
...
Run the QEMU with HES and network this time. Use the --run-only param from now on
...
* Cloning the [https://github.com/veraison/services](https://github.com/veraison/services) repo to `CCA/islet/exmaples/veraison/services` .
