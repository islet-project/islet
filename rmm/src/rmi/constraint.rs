...
fn pick(cmd: Command) -> Option<Constraint> {
    let constraint = match cmd {
        ...
        rmi::SHARED_DATA_CREATE => Constraint::new(rmi::SHARED_DATA_CREATE, 5, 1),
        rmi::SHARED_DATA_DESTROY => Constraint::new(rmi::SHARED_DATA_DESTROY, 3, 3),
        ...
        rmi::RTT_INIT_RIPAS => Constraint::new(rmi::RTT_INIT_RIPAS, 5, 2),
        rmi::RTT_SET_RIPAS => Constraint::new(rmi::RTT_SET_RIPAS, 6, 2),
        rmi::MAP_SHARED_MEM_AS_RO => Constraint::new(rmi::MAP_SHARED_MEM_AS_RO, 5, 1),
        rmi::UNMAP_SHARED_REALM_MEM => Constraint::new(rmi::UNMAP_SHARED_REALM_MEM, 4, 1),
