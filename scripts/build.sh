...
cargo build --release
${CROSS_COMPILE}objcopy -O binary ${ROOT}/out/aarch64-unknown-none/release/rmm ${ROOT}/out/aarch64-unknown-none/release/rmm.bin;
...
${FIPTOOL} create \
 ...
 --rmm-fw ${ROOT}/out/aarch64-unknown-none/release/rmm.bin \
